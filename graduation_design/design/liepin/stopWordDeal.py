...
def dealText(data):
    ...
    for i in range(data.shape[0]):
        ...
        jobDetailText = data.loc[i]['company_business']
        # 去除符号
...
if __name__ == '__main__':
    ...
    inputStopWordsFilePath = r'../deal/file/stopwords.txt'

    jieba.load_userdict(r'./userdice.txt')

    # 读取文件
    allData = pd.read_excel(r'./new_liepin_data1.xlsx', encoding='utf-8', index_col=0)
